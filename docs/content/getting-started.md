...
$ go get github.com/RobertoOrtis/fastgql
```
...
```bash
$ go run github.com/RobertoOrtis/fastgql init
```
...
And run `go run github.com/RobertoOrtis/fastgql generate`.
...
```go
//go:generate go run github.com/RobertoOrtis/fastgql
```
