...
server in gqlgen. You can find the finished result in the [examples directory](https://github.com/RobertoOrtis/fastgql/tree/master/example/federation).
...
```bash
go run github.com/RobertoOrtis/fastgql
```
